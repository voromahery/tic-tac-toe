...
export default function Home(){
    ...
    <div className="board">
        <div className='player-option'>
            ...
            <input type="text" placeholder="leave empty to use AI or enter player name" value={firstPlayer} onChange={(e) => dispatch(addNewFirstPlayer(e.target.value))} name='first player name'/>
        </div>
        <div className='player-option'>
